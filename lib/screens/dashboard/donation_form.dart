                              ...
                              if (_formKey.currentState.validate()) {
                                if(_dropDownValue==null){
                                  Scaffold.of(context).showSnackBar(
                                    SnackBar(content: Text('Select the Ngo Name'),)
                                  );
                                }
                                else{
                                  ...
                                  Scaffold.of(context).showSnackBar(
                                    ...
                                    FirebaseAuthentication.addDonations(ngoName:_dropDownValue,address:_address,date:_date,time:_time,foodItem:_foodItem,quantity:_quantity,callback:callBack);
                                }
                              } 
                            },
                            child: Container(
