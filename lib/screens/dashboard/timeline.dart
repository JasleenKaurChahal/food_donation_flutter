  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child:Column(children: <Widget>[
        ...
        //SizedBox(height: 10.0,),
        Text('Want To Share Food?',style: TextStyle(
        ...
        SizedBox(height: 5.0,),
        Text('Choose one!',style: TextStyle(
          decoration:TextDecoration.none,
          color:Color.grey,
          fontSize: 15.0,
          ),
          ...
          children: <Widget>[
            Column(children: <Widget>[
              Container(
                ...
                SizedBox(height: 10.0,),
                Text('Donate',style: TextStyle(color: Color.black,fontSize: 18.0),),
                Text('Choose to self donate',style:TextStyle(color: Color.grey)),
            ],
          ),   
        SizedBox(width: 30.0,),
        Column(children: <Widget>[
              ...
              decoration: BoxDecoration(
                ...
                SizedBox(height: 10.0,),
                Text('NGO Agent',style: TextStyle(color: Color.black,fontSize: 18.0),),
                Text('Call an NGO Agent to donate',style:TextStyle(color: Color.grey)),
            ],
          ),   
        ],),
