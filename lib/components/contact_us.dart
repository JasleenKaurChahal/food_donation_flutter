    ...
    return Scaffold(
      ...
      body:Container(
        ...
        child: ListView(children: <Widget>[
          Text('Contact Us',style: TextStyle(color: Color.primaryColor,fontSize: 25.0),textAlign: TextAlign.center,),
          SizedBox(height: 20.0,),
          Carousal(),
          SizedBox(height: 20.0,),
          Text('Phone no : 6283746668\nEmail:fooddonation@ngo.com\n',style: TextStyle(color: Color.black,fontSize: 15.0),textAlign: TextAlign.center,),
